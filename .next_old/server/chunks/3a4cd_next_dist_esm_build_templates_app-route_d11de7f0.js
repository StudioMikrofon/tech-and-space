module.exports=[101687,e=>{"use strict";var t=e.i(516669),n=e.i(165195),r=e.i(47167),i=e.i(322887),a=e.i(253219),o=e.i(700279),s=e.i(430803),l=e.i(478041),u=e.i(997684),c=e.i(515157),d=e.i(125451),p=e.i(833697),g=e.i(302794),f=e.i(903936),m=e.i(124496),E=e.i(193695);e.i(667545);var R=e.i(631e3),w=e.i(818814),h=e.i(394875),_=e.i(522734),y=e.i(814747);let T="/opt/openclaw/futurepulse/images",x="/opt/openclaw/workspace/tech-pulse-css/public/images/articles",j=[T];function S(e=!1){return new h.default("/opt/openclaw/futurepulse/db/futurepulse.db",{readonly:e})}let N="/tmp/nextjs_build.lock";function b(){return!function(){if(!(0,_.existsSync)(N))return!1;try{let{time:e}=JSON.parse((0,_.readFileSync)(N,"utf8"));if(Date.now()-new Date(e).getTime()>6e5)return(0,_.unlinkSync)(N),!1;return!0}catch{return!1}}()&&((0,_.writeFileSync)(N,JSON.stringify({pid:process.pid,time:new Date().toISOString()})),!0)}let v="/opt/openclaw/workspace/tech-pulse-css/scripts/atomic-build.sh";function A(e,t=50){let n=e.toLowerCase();for(let[e,t]of Object.entries({č:"c",ć:"c",š:"s",ž:"z",đ:"dj",Č:"c",Ć:"c",Š:"s",Ž:"z",Đ:"dj"}))n=n.split(e).join(t);return(n=(n=n.normalize("NFKD").replace(/[^\x00-\x7F]/g,"")).replace(/[^a-z0-9]+/g,"-").replace(/-+/g,"-").replace(/^-|-$/g,"")).slice(0,t)}let C="/opt/openclaw/workspace/tech-pulse-css/content";function k(e){if(!e||!(0,_.existsSync)(C))return null;try{for(let t of(0,_.readdirSync)(C)){let n,r=y.default.join(C,t);try{n=(0,_.readdirSync)(r)}catch{continue}for(let t of n){let n=y.default.join(r,t,"index.mdx");if(!(0,_.existsSync)(n)||!(0,_.readFileSync)(n,"utf8").slice(0,2e3).includes(`db_id: ${e}`))continue;let i=t.match(/^(\d{4}-\d{2}-\d{2})-(.+)$/),a=i?i[2]:t;if(!(0,_.existsSync)(x))return{mdxPath:n,imageSlug:a,imageFolder:a};let o=(0,_.readdirSync)(x),s=o.find(e=>e===a);if(s)return{mdxPath:n,imageSlug:a,imageFolder:s};let l=o.find(e=>e===t);if(l)return{mdxPath:n,imageSlug:a,imageFolder:l};let u=o.find(e=>e.endsWith("-"+a)||e===a);if(u)return{mdxPath:n,imageSlug:a,imageFolder:u};return{mdxPath:n,imageSlug:a,imageFolder:a}}}}catch{}return null}function O(e){if(!e||!(0,_.existsSync)(x))return null;let t=A(e),n=(0,_.readdirSync)(x);return n.find(e=>e===t)??n.find(e=>e.endsWith("-"+t))??null}function F(e){let{images:t,folderName:n}=function(e){let t=[],n=new Set,r=e.id,i=(e,r,i,a)=>{n.has(a)||(n.add(a),(0,_.existsSync)(a)&&t.push({id:e,url:r,label:i,osPath:a}))},a=k(r),o=a?.imageFolder??O(e.title_en),s=`art${r}_`;if(o){let e=y.default.join(x,o);try{for(let t of(0,_.readdirSync)(e).sort()){let n,r=y.default.extname(t).toLowerCase();if(![".jpg",".jpeg",".png",".webp"].includes(r))continue;let a=y.default.join(e,t),l=t.toLowerCase();if(l.startsWith("main"))n="✓ Main (aktivan)";else if(l.startsWith("subtitle"))n="✓ Subtitle (aktivan)";else{if(!t.startsWith(s))continue;n=l.includes("_main_")?`Gen Main — ${t}`:l.includes("_sub_")?`Gen Sub — ${t}`:`Gen — ${t}`}let u=`/api/foto-review/img?folder=${encodeURIComponent(o)}&file=${encodeURIComponent(t)}`;i(`pub:${o}/${t}`,u,n,a)}}catch{}}if(r)try{for(let e of(0,_.readdirSync)(T).sort()){if(!e.startsWith(s))continue;let t=y.default.extname(e).toLowerCase();if(![".jpg",".jpeg",".png",".webp"].includes(t))continue;let n=y.default.join(T,e),r=e.toLowerCase(),a=`Gen (legacy) — ${e}`;r.includes("_main_")?a=`Gen Main (legacy) — ${e}`:r.includes("_sub_")&&(a=`Gen Sub (legacy) — ${e}`),i(`gen:${e}`,`/api/foto-review/img?file=${encodeURIComponent(e)}`,a,n)}}catch{}return{images:t,folderName:o??null}}(e);return{id:e.id,title:e.title,title_en:e.title_en,category:e.category,lead:e.lead?e.lead.slice(0,220):"",pipeline_stage:e.pipeline_stage,status:e.status,github_uploaded:e.github_uploaded,created_at:e.created_at,images:t,folderName:n}}async function L(t){let n=new URL(t.url),r=n.searchParams.get("id"),i=n.searchParams.get("log");if(n.searchParams.get("queue"))try{let e=S(!0);e.exec(`CREATE TABLE IF NOT EXISTS task_queue (
        ...
        created_at TEXT DEFAULT (datetime('now')), done_at TEXT)`);let t=e.prepare("SELECT id, article_id, task_type, model, status, error_msg, created_at, done_at FROM task_queue ORDER BY id DESC LIMIT 80").all(),n=e.prepare("SELECT status, COUNT(*) as n FROM task_queue GROUP BY status").all();return e.close(),w.NextResponse.json({tasks:t,counts:n})}catch(e){return w.NextResponse.json({tasks:[],counts:[],error:e.message})}if(i)try{let{readFileSync:t}=await e.A(323970),n=t("/opt/openclaw/futurepulse/logs/image_regen.log","utf8").split("\n").filter(Boolean),r=Math.min(parseInt(i,10)||40,200);return w.NextResponse.json({lines:n.slice(-r)})}catch{return w.NextResponse.json({lines:[]})}try{let e=S(!0);if(r){let t=e.prepare(`SELECT id, title, title_en, category, lead, pipeline_stage, status,
           ...
           FROM articles WHERE id = ?`).get(Number(r));if(e.close(),!t)return w.NextResponse.json({error:"Not found"},{status:404});return w.NextResponse.json({article:F(t)})}let t=e.prepare(`SELECT id, title, title_en, category, lead, pipeline_stage, status,
                images_json, github_uploaded, created_at
         FROM articles
         ORDER BY id ASC`).all();return e.close(),w.NextResponse.json({articles:t.map(F),total:t.length})}catch(t){let e=t instanceof Error?t.message:String(t);return w.NextResponse.json({error:e},{status:500})}}async function I(t){try{let n=await t.json(),{action:r,articleId:i}=n;if(!i)return w.NextResponse.json({error:"Missing articleId"},{status:400});let a=S(),o=a.prepare("SELECT id, title, title_en, category, images_json FROM articles WHERE id = ?").get(i);if(!o)return a.close(),w.NextResponse.json({error:"Article not found"},{status:404});if("delete_article"===r){if(!a.prepare("SELECT id, title FROM articles WHERE id = ?").get(i))return a.close(),w.NextResponse.json({error:"Članak ne postoji",ok:!1},{status:404});let t=e.r(522734),n=k(i),r=new Set;try{for(let e of(0,_.readdirSync)(C)){let t,n=y.default.join(C,e);try{t=(0,_.readdirSync)(n)}catch{continue}for(let e of t){let t=y.default.join(n,e);try{(0,_.readdirSync)(t)}catch{continue}for(let e of["index.mdx","index.en.mdx","index.hr.mdx"]){let n=y.default.join(t,e);(0,_.existsSync)(n)&&(0,_.readFileSync)(n,"utf8").slice(0,2e3).includes(`db_id: ${i}`)&&r.add(t)}}}for(let e of r)try{t.rmSync(e,{recursive:!0,force:!0}),console.log(`Deleted MDX folder: ${e}`)}catch(t){console.error(`Failed to delete MDX folder ${e}: ${t}`)}}catch(e){console.error(`Error scanning for MDX files: ${e}`)}if(n?.imageFolder)try{let e=y.default.join(x,n.imageFolder);t.rmSync(e,{recursive:!0,force:!0}),console.log(`Deleted image folder: ${e}`)}catch(e){console.error(`Failed to delete image folder: ${e}`)}a.prepare("DELETE FROM articles WHERE id = ?").run(i),a.close();{let{spawn:t}=await e.A(144264);b()?t("bash",["-c",v],{detached:!0,stdio:"ignore"}).unref():(0,_.writeFileSync)("/tmp/nextjs_rebuild_needed","1")}return w.NextResponse.json({ok:!0,message:`✅ Članak "#${i}" trajno obrisan (MDX + EN/HR verzije + slike + DB)`})}if("delete_image"===r){let{imageId:e}=n;if(!e)return a.close(),w.NextResponse.json({error:"Missing imageId"},{status:400});let t=null;if(e.startsWith("gen:")){let n=e.slice(4);t=j.map(e=>y.default.join(e,n)).find(e=>(0,_.existsSync)(e))??null}else e.startsWith("pub:")&&(t=y.default.join(x,e.slice(4)));if(!t||!(0,_.existsSync)(t))return a.close(),w.NextResponse.json({error:"Slika nije pronađena"},{status:404});try{(0,_.unlinkSync)(t)}catch(e){return a.close(),w.NextResponse.json({error:"Brisanje nije uspjelo"},{status:500})}let r=o.images_json;if(r)try{let e=JSON.parse(r),n=y.default.basename(t),o=!1;e.image_main?.url?.includes(n)&&(delete e.image_main,o=!0),e.image_subtitle?.url?.includes(n)&&(delete e.image_subtitle,o=!0),o&&a.prepare("UPDATE articles SET images_json = ? WHERE id = ?").run(JSON.stringify(e),i)}catch{}return a.close(),w.NextResponse.json({ok:!0,message:"Slika obrisana"})}if("select_images"===r){let t,{heroImageId:r,subtitleImageId:s}=n,l=e=>{if(!e)return null;if(e.startsWith("gen:")){let t=e.slice(4);return j.map(e=>y.default.join(e,t)).find(e=>(0,_.existsSync)(e))??null}return e.startsWith("pub:")?y.default.join(x,e.slice(4)):null},u=l(r);if(!u||!(0,_.existsSync)(u))return a.close(),w.NextResponse.json({error:"Hero slika nije pronađena"},{status:400});let c=s?l(s):null,d=k(i);if(d?.imageFolder)t=d.imageFolder;else{let e=A(o.title_en||o.title);t=O(o.title_en)??e}let p=y.default.join(x,t);(0,_.mkdirSync)(p,{recursive:!0});let g=y.default.extname(u).toLowerCase()||".jpg",f=y.default.join(p,`main${g}`);u!==f&&(0,_.copyFileSync)(u,f);let m=null;if(c&&(0,_.existsSync)(c)){let e=y.default.extname(c).toLowerCase()||".jpg";m=y.default.join(p,`subtitle${e}`),c!==m&&(0,_.copyFileSync)(c,m)}let E={},R={};try{let e=JSON.parse(o.images_json||"{}");E=e.image_main||{},R=e.image_subtitle||{}}catch{}let h=`/images/articles/${t}/main${g}`,T=m?`/images/articles/${t}/subtitle${y.default.extname(m).toLowerCase()||".jpg"}`:null,S={image_main:{...E,url:h},success:!0};T?S.image_subtitle={...R,url:T}:R.url&&(S.image_subtitle=R),a.prepare("UPDATE articles SET images_json = ? WHERE id = ?").run(JSON.stringify(S),i),a.close(),function(e,t,n){let r=k(e),i=r?.mdxPath,a=(r,i=!0)=>{if(!(0,_.existsSync)(r))return!1;let a=(0,_.readFileSync)(r,"utf8");return(!i||!!a.includes(`db_id: ${e}`))&&(a=a.replace(/^(image:\n\s+url:\s*)"[^"]*"/m,`$1"${t}"`),n&&/^subtitleImage:/m.test(a)&&(a=a.replace(/^(subtitleImage:\n\s+url:\s*)"[^"]*"/m,`$1"${n}"`)),(0,_.writeFileSync)(r,a,"utf8"),!0)};try{if(i&&a(i,!0)){let e=y.default.join(y.default.dirname(i),"index.hr.mdx");return(0,_.existsSync)(e)&&a(e,!1),!0}let e=y.default.join(process.cwd(),"content");for(let t of(0,_.readdirSync)(e)){let n,r=y.default.join(e,t);try{n=(0,_.readdirSync)(r)}catch{continue}for(let e of n){let t=y.default.join(r,e,"index.mdx");if(a(t,!0)){let t=y.default.join(r,e,"index.hr.mdx");return(0,_.existsSync)(t)&&a(t,!1),!0}}}}catch(e){console.error("updateMdxImages error:",e)}}(i,h,T);let{spawn:N}=await e.A(144264);if(!b())return w.NextResponse.json({ok:!0,message:`⏳ Build već u tijeku — čekaj ~2min prije nego što pokušaš ponovno`,building:!0});return N("bash",["-c",v],{detached:!0,stdio:"ignore"}).unref(),w.NextResponse.json({ok:!0,message:`✓ Slike snimljene u ${t} — rebuild pokrenut (~2min)`})}if("regen_endings"===r){let{spawn:t}=await e.A(144264),n=`
import sys, asyncio
sys.path.insert(0, '.')
import logging
