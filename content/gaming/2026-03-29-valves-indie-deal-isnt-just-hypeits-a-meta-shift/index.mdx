...
For players, the takeaway is simple: More weird, experimental games—*if* Valve doesn’t fumble the rollout. Keep an eye on Steam’s ‘Trending’ tab over the next few months; that’s where the real signal will be.
