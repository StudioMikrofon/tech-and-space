...
Will Notification Rules actually change user behavior, or will it join the graveyard of Android features that sounded good in code but faded in practice? The answer won’t come from specs or beta tests, but from whether it makes someone’s Tuesday afternoon just a little less chaotic.
