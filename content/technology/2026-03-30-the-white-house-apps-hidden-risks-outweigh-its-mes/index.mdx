...
image:
  ...
  caption: "A smartphone lying on brushed aluminum surface displaying a precise grid map with a single GPS coordinate marker, its screen casting cool white light"
...
subtitleImage:
  ...
  caption: "A glowing computer monitor displaying lines of syntax reflected faintly on a brushed aluminum surface, with a heavy metallic magnifying glass resting"
  credit: "Photo by Tech&Space"
...
featured: false
approved: true
title_en: "The White House App’s Hidden Risks Outweigh Its Messaging"
key_points_en:
  - "Executable code pulled from GitHub"
  - "Background GPS tracking without consent"
  - "Privacy dialogs stripped in built-in browser"
