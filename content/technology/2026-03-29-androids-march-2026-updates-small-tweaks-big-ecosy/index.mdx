...
Will this approach backfire? The updates are smartly low-key, but the cumulative effect could draw scrutiny from regulators and competitors alike. The question isn’t whether Google can pull this off—it’s how long the industry will tolerate the slow creep of an ecosystem that’s becoming harder to opt out of.
