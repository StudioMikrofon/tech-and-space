...
The real signal here isn’t just the spyware itself, but the method of delivery. By hijacking a trusted brand, the attackers didn’t just compromise 200 users—they exposed a systemic weakness in how we verify the apps we use every day.
