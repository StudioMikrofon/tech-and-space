...
image:
  ...
  caption: "A browser tab displaying the DarkSword GitHub repository rendered on a matte aluminium laptop screen, photographed from an extreme angle so only the"
...
subtitleImage:
  ...
  caption: "DarkSword leak forces Apple’s hand on legacy iOS updates"
  credit: "Photo by Tech&Space"
...
featured: false
approved: true
title_en: "DarkSword leak forces Apple’s hand on legacy iOS updates"
key_points_en:
  - "Exploit targets iPhones and iPads on outdated iOS"
  - "GitHub leak accelerates patch urgency for users"
  - "Google’s disclosure shifts industry risk calculus"
