...
Will this become a permanent feature, or will the backlash from the community force a rollback? Either way, the precedent is set: Linux is no longer immune to the content moderation wars—and that may be the most significant shift of all.
