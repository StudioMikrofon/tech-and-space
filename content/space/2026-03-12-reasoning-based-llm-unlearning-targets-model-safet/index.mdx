...
part1_en: "The ability for artificial intelligence systems to selectively \"forget\" information has emerged as one of the most pressing challenges in deploying large language models responsibly. A new paper published on [arXiv](https://arxiv.org/abs/2603.09980v1) introduces reasoning-based unlearning, a novel approach designed to address the fundamental limitations of current unlearning methods.
