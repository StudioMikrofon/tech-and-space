...
excerpt: "NomadicML je prikupio 8,4 milijuna dolara za platformu koja autonomne videozapise pretvara u strukturirane podatke."
exec_summary: "NomadicML’s $8.4M seed round backs a platform that turns autonomous vehicle footage into searchable datasets. The important question is whether it can scale cleanly across noisy sensors, real-time costs, and safety-critical workflows without turning data plumbing into the bottleneck."
key_points:
...
subtitle: "Kaos AV podataka traži red"
subtitleImage:
  url: "/images/articles/nomadic-raises-8-4m/subtitle.jpg"
  alt: "Kad video postane dataset, problem tek počinje"
tags: ["AV data", "dataset", "computer vision", "autonomous vehicles", "pipeline"]
lead_sentence: "NomadicML pokušava pretvoriti snimke iz autonomnih vozila u nešto što se stvarno može pretraživati."
geo:
  name: "Seattle, WA"
  lat: 47.6062
  lon: -122.3321
...
featured: false
approved: true
summary_block: "Podaci su vrijedni samo ako ih ljudi mogu koristiti bez dodatnog ručnog kopanja. To je ovdje i glavna tehnološka barijera."
author: "STEEL PULSE"
