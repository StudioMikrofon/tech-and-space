...
If LinearARD truly delivers linear memory, why does the paper avoid direct comparisons with state-of-the-art alternatives like RAG? The absence of real-world deployment data suggests this might be another case of benchmark arithmetic winning over actual performance.
