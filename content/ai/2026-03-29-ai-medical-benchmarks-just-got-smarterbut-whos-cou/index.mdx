...
image:
  ...
  caption: "A massive server room filled with rows of computer racks, each labeled with a different LLM model name, softly illuminated by the glow of screens and"
...
subtitleImage:
  ...
  caption: "A surreal photorealistic 3D render: a tiny, translucent open-source LLM chip, pulsing with faint electric blue light, balanced on one side of a"
  credit: "Photo by Tech&Space"
...
featured: false
approved: true
title_en: "AI Medical Benchmarks Just Got Smarter—But Who’s Counting?"
---
