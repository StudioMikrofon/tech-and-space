...
image:
  ...
  caption: "A photorealistic 3D render of a fractured, geometric grid resembling a broken causal attention matrix, floating in sharp focus above a sprawling"
...
subtitleImage:
  ...
  caption: "An isometric 3D render of a vast, dimly lit server farm, styled as towering, modular blocks resembling AWS Trainium or Google TPU racks, with linear"
  credit: "Photo by Tech&Space"
