...
image:
  ...
  caption: "A photorealistic 3D render of a synthetic X-ray image on a hospital computer screen, with a radiologist's hand hovering over the mouse, set against a"
...
subtitleImage:
  ...
  caption: "A close-up of a server rack corridor in a hospital's data center, with rows of machines humming in the background, and a robotic arm reaching in to"
  credit: "Photo by Tech&Space"
...
approved: true
title_en: "Deepfake X-Rays Are Fooling Radiologists"
---
