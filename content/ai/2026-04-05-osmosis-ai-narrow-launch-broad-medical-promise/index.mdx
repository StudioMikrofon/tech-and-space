...
For all the ‘millions of clinicians’ Osmosis claims, it’s curious that the AI is still a med-student exclusive. If this tool is so transformative, why not release it to the thousands of practicing physicians already using Osmosis? Or is the demo more impressive than the deployment?
