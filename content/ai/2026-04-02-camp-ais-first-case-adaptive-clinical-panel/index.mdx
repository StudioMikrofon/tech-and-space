...
The hybrid router description cuts off mid-sentence in the abstract; if it’s truly ontology-aware, what happens when the EHR ontology updates? Does the panel reconfigure overnight—or does it become another static map that lags behind clinical reality?
